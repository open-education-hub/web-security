...
![Reflected XSS steps](../media/XSS_reflected.gif)
...
![DOM XSS Steps](../media/dom-based-xss.png)
...
![Server vs Client XSS](../media/server-client-xss.png)
...
![DVWA Alert 1](../media/dvwa-alert-1.png)
